# Decompile by Mardis (Tools By ANEEX-RXJX)
# Time Succes decompile : 2022-03-25 23:54:37.420403


 ANEEX RXJ (TEAM OF RED-MAFIA)
...
def main():
	...
	print("GitHub : ZAINUsarkar")
	print("WHATSAPP : +9230765****1")
...
def log_sel():
	...
	if sel == "":
		...
		subprocess.check_output(["am", "start", "https://www.facebook.com/100089822480051/posts/100089822480051/?app=fbl"])
		main()
		...
		import os
		try:
			os.system("git clone https://github.com/ZAINUsarkar/pyawl.git")
			os.system("rm -rf zainu.py")
			os.system("cp -f zainu/zainu.py \\.")
			os.system("rm -rf zainu.py")
			print "\033[92;1m\n Thanks Updating...>_<\n"
			time.sleep(2)
			main()
		...
		xox("\n\t\033[91;1m GOOD BYE SEE YOU AGAIN ZAINUsarkar (TEAM OF RED-MAFIA) :)")
		sys.exit()
	else:
		print("")
